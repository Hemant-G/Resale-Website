...
const Banner = () => {
  return (
    <div className="bg-indigo-100 border border-indigo-300 text-indigo-800 font-medium px-4 py-3 rounded-lg shadow-sm flex items-center justify-between mb-6">
